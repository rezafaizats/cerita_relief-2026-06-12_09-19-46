...
namespace BookCurlPro
{
    ...
    public class BookPro : MonoBehaviour
    {
        ...
        public int PreviousPaper  {
            get {return pageDragging ? currentPaper - 2 : currentPaper - 1;}
        }
        ...
        public void DragRightPageToPoint(Vector3 point)
        {
            ...
            Left = papers[currentPaper - 1].Front.GetComponent<RectTransform>();
            ...
            Right = papers[currentPaper - 1].Back.GetComponent<RectTransform>();
        ...
        public void UpdateBookRTLToPoint(Vector3 followLocation)
        {
            ...
            Shadow.rectTransform.SetParent(Right, true);
        }
